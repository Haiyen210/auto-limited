                                ...
                                <div class="btn-group languages-block ">
                                    <form action="https://demo.smartaddons.com/templates/html/autoparts/index.html" method="post" enctype="multipart/form-data" id="bt-language">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="index-2.html"><img class="image_flag" src="image/catalog/flags/gb.png" alt="English" title="English" /> English </a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 middle-right">
                        <div class="logo">
                            <a href="index-2.html"><img src="image/catalog/logo.png" title="Your Store" alt="Your Store" /></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-3">
