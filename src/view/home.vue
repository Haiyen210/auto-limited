                            ...
                            <div class="wap-listing-tabs products-list grid">
                                <div class="ltabs-items-container">                                    
                                    ...
                                    <div class="ltabs-items ltabs-items-selected items-category-34" data-total="16">
                                        ...
                                        <div class="owl2-stage-outer"><div class="owl2-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1200px;"><div class="owl2-item active" style="width: 270px; margin-right: 30px;"><div class="item">
                                                <div class="product-layout product-grid">                                               
                                                    <div class="product-item-container item--static">
                                                        <div class="left-block">
                                                            <div class="product-image-container second_img">
                                            ...
                                            </div></div><div class="owl2-item active" style="width: 270px; margin-right: 30px;"><div class="item">
                                                <div class="product-layout product-grid">                                                 
                                                    <div class="product-item-container item--static">
                                                        <div class="left-block">
                                                            <div class="product-image-container second_img">
